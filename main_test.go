...
import (
	...
	"github.com/wrongcommen/got/internal/got"
...
func TestGot(t *testing.T) {
	...
	args = "-t got -i -o github.com/wrongcommen/got/internal/testdata/template -I github.com/wrongcommen/got/internal/testdata/src/inc2:github.com/wrongcommen/got/internal/testdata/src/inc:github.com/wrongcommen/got/internal/testdata/src/inc/testInclude4.inc -d github.com/wrongcommen/got/internal/testdata/src"
...
func TestRecursiveGot(t *testing.T) {
	...
	err := got.Run("",
		...
		false,
		"",
		"github.com/wrongcommen/got/internal/testdata/src/recurse",
		nil,
		true,
		true,
		false)
